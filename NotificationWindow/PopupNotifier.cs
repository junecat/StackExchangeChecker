...
namespace NotificationWindow
{
    ...
    public class PopupNotifier : Component
    {
        ...
        [Description("Need for displayed while user clicked to window")]
        public bool IgnoreTimer { set; get; }

        [Description("Do not close window by click on close button")]
        public bool IgnoreClose { set; get; }
